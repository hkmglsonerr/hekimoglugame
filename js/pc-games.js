...
if (window.location.href == "http://127.0.0.1:5501/pc-games.html") {
  const row = document.querySelector(".row");
  ...
  urunler.forEach((urun) => {
    ...
    parentDiv.style.border = "3px solid #E92F48";
    ...
    baslik.classList.add("baslik","ms-5","text-align-center","justify-content-center","align-items-center");

    const aciklama = document.createElement("p");
    aciklama.textContent = ` ${urun.fiyat}$`;
    aciklama.classList.add("aciklama","ms-5","text-align-center","justify-content-center","align-items-center");
...
} else if (window.location.href == "http://127.0.0.1:5501/sepet.html") {
  ...
  if (sepet.length == 0) {
    ...
    sepetBtn.addEventListener("click", () => {
      localStorage.setItem("sepet", JSON.stringify(sepet));
      window.location.href = "http://127.0.0.1:5501/kredikart%C4%B1.html";
    });
